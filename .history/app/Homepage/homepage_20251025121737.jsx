            ...
            <main className={styles.homepage__main}>
                <div className={styles.homepage__content}>
                    <div className={styles.hompage__button__container}>
                        ...
                        <Modal
                            buttontitle='Edit'
                            buttonstyle={`${buttonStyles.button} ${buttonStyles["button--edit"]} ${buttonStyles["button--medium"]}`}
                            /* Tente uma dessas 2 linhas para desabilitar visualmente quando nada estiver selecionado: */
                            disabled={!selectedBook} // ✅ se o Modal repassa para <button>
                            // buttonProps={{ disabled: !selectedBook }}           // ✅ alternativa comum em alguns Modals
                        >
                            {(close) => (
                                <BookForm
                        ...
                        {/* DELETE */}
                        <button
                            className={`${buttonStyles.button} ${buttonStyles["button--delete"]} ${buttonStyles["button--medium"]}`}
                            onClick={() =>
