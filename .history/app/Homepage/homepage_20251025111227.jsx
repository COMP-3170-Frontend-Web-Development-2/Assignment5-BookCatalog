...
function Homepage() {
    ...
    // // to not display books at the begining + all the books start not selected
    // useEffect(() => {
    //     const booksWithSelected = booksData.map((book) => ({
    //         ...book,
    //         selected: false,
    //     }));
    ...
    function handleAddBook(newBook) {
        const newBookWithSelected = { ...newBook, selected: false };
