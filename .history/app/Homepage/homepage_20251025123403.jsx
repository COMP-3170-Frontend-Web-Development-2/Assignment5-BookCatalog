...
import modalStyles from "../_ui/modal/modal.module.css";
                ...
                <div className={styles.homepage__content}>
                    <div className={styles.hompage__button__container}>
                        ...
                        <Modal
                            ...
                            buttonstyle={`${modalStyles.buttonstyle} ${modalStyles["buttonstyle--add"]}`}>
                            {(close) => (
                                <BookForm
                                    onSubmit={(data) => {
                                        handleAddBook(data);
                        ...
                        <Modal
                            buttontitle='Edit'
                            buttonstyle={`${modalStyles.buttonstyle} ${modalStyles["buttonstyle--edit"]}`}>
                            {(close) => (
                                <BookForm
